...
- [#3671](https://github.com/xmrig/xmrig/pull/3671) Исправлено определение размера кэша L2 для некоторых сложных NUMA топологий
- [#3674](https://github.com/xmrig/xmrig/pull/3674) Исправлена ​​сборка ARMv7
- [#3677](https://github.com/xmrig/xmrig/pull/3677) Исправлена ​​автоматическая настройка для процессоров AMD с кэшем L3 > 2 МБ на поток
- [#3678](https://github.com/xmrig/xmrig/pull/3678) Улучшена поддержка IPv6: новые настройки по умолчанию используют IPv6 наравне с IPv4
